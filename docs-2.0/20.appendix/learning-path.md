...
### 2.1 安装 NebulaGraph
  ...
  | [使用源码](https://docs.nebula-graph.com.cn/{{nebula.release}}/4.deployment-and-installation/2.compile-and-install-nebula-graph/1.install-nebula-graph-by-compiling-the-source-code/) | [图数据库入门教程（零）通过编译源码来安装 NebulaGraph](https://www.bilibili.com/video/BV1YJ411i7Jn?spm_id_from=333.999.0.0)                                                             |
...
### 2.2 启动 NebulaGraph
  ...
  | 文档                                                         |
  | ------------------------------------------------------------ |
  | [启停 NebulaGraph](https://docs.nebula-graph.com.cn/{{nebula.release}}/2.quick-start/5.start-stop-service/) |
...
### 3.1 部署多机集群
  ...
  | 文档 |
  | ------------------------------------------------------------ |
  | [使用 RPM/DEB 包部署 NebulaGraph 多机集群](https://docs.nebula-graph.com.cn/{{nebula.release}}/4.deployment-and-installation/2.compile-and-install-nebula-graph/deploy-nebula-graph-cluster/) |  

### 3.2 升级集群版本

  | 文档                                                         |
  | ------------------------------------------------------------ |
  | [升级 NebulaGraph](https://docs.nebula-graph.com.cn/{{nebula.release}}/4.deployment-and-installation/3.upgrade-nebula-graph/upgrade-nebula-graph-to-latest/) |
...
- 监控
  ...
  | 文档                                                         |
  | ------------------------------------------------------------ |
  | [NebulaGraph 指标](https://docs.nebula-graph.com.cn/{{nebula.release}}/6.monitor-and-metrics/1.query-performance-metrics/) |
...
### 3.6 性能调优
  ...
  | 文档     |视频|
  | ------------------- |------------------- |
  | [图建模](https://docs.nebula-graph.com.cn/{{nebula.release}}/8.service-tuning/2.graph-modeling/) |[NebulaGraph 高性能图 schema 设计](https://www.bilibili.com/video/BV1r64y1R72i?)|
...
- 云
  ...
  |Cloud 版本|文档|视频| 
  |---------|---------|--------|
  |Azure 版|[NebulaGraph Cloud Azure云版](https://docs.nebula-graph.com.cn/2.6.2/nebula-cloud/1.what-is-cloud/)|-|
...
- 可视化
  ...
  | 可视化工具     | 文档                                                         | 视频                                                         |
  | -------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
  | 数据可视化     | [NebulaGraph Studio](https://docs.nebula-graph.com.cn/{{nebula.release}}/nebula-studio/about-studio/st-ug-what-is-graph-studio/) | [NebulaGraph Studio 图探索功能](https://www.bilibili.com/video/BV1QN411Z7Vh)和[NebulaGraph Studio 可视化建模](https://www.bilibili.com/video/BV19A411L77h?spm_id_from=333.999.0.0) |
  | 数据监控和运维 | [NebulaGraph Dashboard 企业版](https://docs.nebula-graph.com.cn/{{nebula.release}}/nebula-dashboard-ent/1.what-is-dashboard-ent/)和 [NebulaGraph Dashboard 社区版](https://docs.nebula-graph.com.cn/{{nebula.release}}/nebula-dashboard/1.what-is-dashboard/) | [可视化监控 NebulaGraph Dashboard](https://www.bilibili.com/video/BV1qQ4y1k7gb?)                                                            |
  | 数据分析       | [NebulaGraph Explorer 企业版](https://docs.nebula-graph.com.cn/{{nebula.release}}/nebula-explorer/about-explorer/ex-ug-what-is-explorer/) | [可视化图探索 NebulaGraph Explorer](https://www.bilibili.com/video/BV1fP4y1h7Fx?)                                                            |

- 数据导入与导出

  | 导入与导出 | 文档                                                         | 视频                                                         |
  | -------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
  | 数据导入       | [NebulaGraph Importer](https://docs.nebula-graph.com.cn/{{nebula.release}}/nebula-importer/use-importer/) | [NebulaGraph Importer](https://www.bilibili.com/video/BV1ny4y1u7i4) |
  | 数据导入       | [NebulaGraph Spark Connector](https://docs.nebula-graph.com.cn/{{nebula.release}}/nebula-spark-connector/) | -                                                            |
  | 数据导入       | [NebulaGraph Flink Connector](https://docs.nebula-graph.com.cn/{{nebula.release}}/nebula-flink-connector/) | -                                                            |
  | 数据导入       | [NebulaGraph Exchange 社区版](https://docs.nebula-graph.com.cn/{{nebula.release}}/nebula-exchange/about-exchange/ex-ug-what-is-exchange/) | [NebulaGraph 数据导入工具——Exchange](https://www.bilibili.com/video/BV1Pq4y177D9)、[Exchange 导入 SST 数据](https://www.bilibili.com/video/BV1y34y1o7Di?)  |
  | 数据导出       | [NebulaGraph Exchange 企业版](https://docs.nebula-graph.com.cn/{{nebula.release}}/nebula-exchange/about-exchange/ex-ug-what-is-exchange/) | -                                                            |
...
- 备份与恢复
  ...
  | 文档                    |     视频                               |
  | ------------------------|------------------------------------ |
  |[NebulaGraph BR](../backup-and-restore/nebula-br/1.what-is-br.md)|[NebulaGraph 容灾备份工具 nebula-br](https://www.bilibili.com/video/BV11L4y1g7rD)|

- 性能测试

  | 文档                                                         |
  | ------------------------------------------------------------ |
  | [NebulaGraph Bench](https://docs.nebula-graph.com.cn/{{nebula.release}}/nebula-bench/) |

- 集群运维

  | 文档  |视频|
  | -------- |---------|
  | [NebulaGraph Operator](https://docs.nebula-graph.com.cn/{{nebula.release}}/nebula-operator/1.introduction-to-nebula-operator/) |[NebulaGraph Operator](https://www.bilibili.com/video/BV1rP4y1x7fX)、[ 云原生的演进](https://www.bilibili.com/video/BV1A5411N7vs)|

- 图算法 

  | 文档   |视频|
  | ------- |------ |
  | [NebulaGraph Algorithm](https://docs.nebula-graph.com.cn/{{nebula.release}}/nebula-algorithm/) |[NebulaGraph Algorithm 介绍](https://www.bilibili.com/video/BV1fB4y1T7XK)|

- 客户端

  | 文档                                                         |
  | ------------------------------------------------------------ |
  | [NebulaGraph Console](https://docs.nebula-graph.com.cn/2.6.1/2.quick-start/3.connect-to-nebula-graph/) |
  | [NebulaGraph CPP](https://docs.nebula-graph.com.cn/2.6.1/14.client/3.nebula-cpp-client/) |
  | [NebulaGraph Java](https://docs.nebula-graph.com.cn/2.6.1/14.client/4.nebula-java-client/) |
  | [NebulaGraph Python](https://docs.nebula-graph.com.cn/2.6.1/14.client/5.nebula-python-client/) |
  | [NebulaGraph Go](https://docs.nebula-graph.com.cn/2.6.1/14.client/6.nebula-go-client/) |
...
## 5. 最佳实践
  ...
  | [微信使用 NebulaGraph 的定制化开发](https://nebula-graph.com.cn/posts/nebula-graph-for-social-networking/) |
  | [知乎使用 NebulaGraph 实践](https://mp.weixin.qq.com/s/K2QinpR5Rplw1teHpHtf4w) |
  |[NebulaGraph 在微众银行的数据治理业务的实践](https://www.bilibili.com/video/BV1Pr4y1F7kA)|
...
## 7. 实操作业
 ...
 用户可以通过完成以下实操作业来检测是否玩转 NebulaGraph。
  ...
  | 作业内容                                                | 参考                                                         |
  | ------------------------------------------------------- | ------------------------------------------------------------ |
  | 编译内核                                                | [使用源码安装 NebulaGraph](https://docs.nebula-graph.com.cn/{{nebula.release}}/4.deployment-and-installation/2.compile-and-install-nebula-graph/1.install-nebula-graph-by-compiling-the-source-code/)                                                             |
  ...
  | 使用 K6 压测 NebulaGraph                               | [K6 在 NebulaGraph 上的压测实践](https://nebula-graph.com.cn/posts/practice-k6-at-nebula-graph/) |
...
考试用书[《开源分布式图数据库 NebulaGraph 完全指南》](https://docs.nebula-graph.com.cn/site/pdf/NebulaGraph-book.pdf)

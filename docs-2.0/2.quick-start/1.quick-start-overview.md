...
用户可通过云及本地两种部署方式快速入门 NebulaGraph。快速入门将介绍如何通过云和本地两种部署方式简单地使用 NebulaGraph，包括部署、连接 NebulaGraph，以及基础的增删改查操作。
...
1. 安装 [Docker Desktop](https://www.docker.com/products/docker-desktop/)。
  ...
  !!! caution
        ...
        如果在 Windows 端安装 Docker Desktop 需[安装 WSL](https://docs.docker.com/desktop/install/windows-install/)。

2. 导航到 Docker Desktop 的扩展市场。
3. 在仪表盘中，搜索 NebulaGraph 或选择菜单栏中的[添加扩展](https://hub.docker.com/extensions/weygu/nebulagraph-dd-ext)程序。
